...
# Input field for GPT API key
openai_api_key = st.sidebar.text_input("Enter your GPT API key:", type="password")
...
if openai_api_key:
    ...
    st.warning("Please enter your GPT API key to continue.")